$('#tableDirectivo').DataTable();

var tableusuarios;

document.addEventListener('DOMContentLoaded',function(){
    tableusuarios = $('#tableDirectivo').DataTable({
        "aProcessing": true,
        "aServerSide": true,
        "language": {
...
function inicioDirectivo(){
    $('#DatosDirectivo').hide();
    $('#EditDatosDirectivo').hide();
}
inicioDirectivo();
function openModalDirectivo()
{
    $('#idusuario').val('');
    $('#tituloModal').html('<i class="fa fa-user-plus" aria-hidden="true"></i> Nuevo Directivo');
    $('#action').html('Guardar');
    $('#botonesDirectivo').hide();
    $('#tituloDirectivo').html('<i class="fa fa-user-plus"></i> Agregar Directivo');
    $('#DatosDirectivo').show();
    $('#listDirectivo').hide();
}


function closeModalDirectivo(){
   
    $('#botonesDirectivo').show();
    $('#tituloDirectivo').html('<i class="fa fa-dashboard"></i> Lista de Directivo');
    $('#DatosDirectivo').hide();
    $('#EditDatosDirectivo').hide();
    $('#listDirectivo').show();
...
function openModalEditarDirectivo()
{
    $('#idusuario').val('');
    $('#tituloModal').html('<i class="fa fa-user-plus" aria-hidden="true"></i> Editar Directivo');
    $('#action').html('Actualizar');
    $('#botonesDirectivo').hide();
    $('#tituloDirectivo').html('<i class="fa fa-user-plus"></i> Editar Directivo');
    $('#EditDatosDirectivo').show();
    $('#listDirectivo').hide();
}

function editarDirectivo(id){
    openModalEditarDirectivo();
    var idUsuario = id;
        $.ajax({
            url		: 'ajax/directivos.ajax.php',
            type	: 'POST',
...
function desactivarDirectivo(id){
    var idusuario = id;
