...
document.addEventListener('DOMContentLoaded',function(){
    tableusuarios = $('#tableprofesores').DataTable({
        "aProcessing": true,
        "aServerSide": true,
        "language": {
...
{
    $('#idusuario').val('');
    $('#tituloModal').html('<i class="fa fa-user-plus" aria-hidden="true"></i> Nuevo Profesor');
    $('#action').html('Guardar');
    $('#botonesProfesor').hide();
    $('#tituloProfesor').html('<i class="fa fa-user-plus"></i> Agregar Profesor');
    $('#DatosProfesor').show();
    $('#listProfesor').hide();
}


function closeModalProfesor(){
   
    $('#botonesProfesor').show();
    $('#tituloProfesor').html('<i class="fa fa-dashboard"></i> Lista de Profesores');
    $('#DatosProfesor').hide();
    $('#EditDatosProfesor').hide();
    $('#listProfesor').show();
...
function openModalEditarProfesor()
{
    $('#idusuario').val('');
    $('#tituloModal').html('<i class="fa fa-user-plus" aria-hidden="true"></i> Editar Profesor');
    $('#action').html('Actualizar');
    $('#botonesProfesor').hide();
    $('#tituloProfesor').html('<i class="fa fa-user-plus"></i> Editar Profesor');
    $('#EditDatosProfesor').show();
    $('#listProfesor').hide();
}

function editarProfesor(id){
    openModalEditarProfesor();
    var idUsuario = id;
        $.ajax({
            ...
            success: function (data) {
                ...
                //datos del apoderado
                $("#editTitulo_profesor").val(data.titulo);
                $("#editNotas_profesor").val(data.notas);
...
function desactivarProfesor(id){
    var idusuario = id;
