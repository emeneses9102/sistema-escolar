<div class="app-title">
  <div>
    <h3 id="tituloDirectivo"><i class="fa fa-user"></i> Lista de Directivo</h1>
  </div>
  <ul class="app-breadcrumb breadcrumb">
    <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
    <li class="breadcrumb-item"><a href="#">Registrar Directivo</a></li>
  </ul>
</div>
<div class="container-fluid mb-2" id="botonesDirectivo" style="margin-top: -10px;">
  <div class="form-inline">
    <button class="btn btn-primary" type="button" onclick="openModalDirectivo()"><i class="fa fa-plus-circle" aria-hidden="true"></i> Nuevo Directivo</button>
    <button class="btn btn-info ml-auto" type="button" onclick=""><i class="fa fa-table" aria-hidden="true"></i> Importar Excel</button>
  </div>

</div>
<div class="row" id="listDirectivo">
  <div class="col-md-12">
    <div class="tile">
      <div class="tile-body">
        <div class="table-responsive">
          <table class="table table-hover table-bordered  m-auto" id="tableDirectivo">
            <thead>
              <tr>
                <th>Acciones</th>
                <th>Nombres</th>
            ...
            <?php
              $item = null;
              $valor = null;
              $directivos = ControladorDirectivo :: ctrMostrarDirectivo($item,$valor);
              foreach($directivos as $value){
                ...
                echo'<tr>
                      <th><button class="btn btn-primary btn-sm mt-1" title="Editar" onclick="editarDirectivo('.$value["usuario_id"].')"><i class="fas fa-user-edit"></i></button>
                      <button class="btn btn-danger btn-sm mt-1 ml-1" title="Eliminar"  onclick="desactivarDirectivo('.$value["usuario_id"].')"><i class="fas fa-user-times"></i></button></th>
                      <th>'.$value["nombres"].'</th>
  ...
  <div class="tile user-settings">
    ...
    <form id="formDirectivo" name="formDirectivo"method="post" enctype="multipart/form-data" rol="form" class="needs-validation" novalidate >
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" onclick="closeModalDirectivo()" data-dismiss="modal">Cerrar</button>
      ...
      <?php
        ...
        $crearDirectivo = new ControladorDirectivo();
        $crearDirectivo->ctrCrearDirectivo();
      ?>
    </form>
  </div>
</div>
...
<div class="tab-pane" id="EditDatosDirectivo">
  <div class="tile user-settings">
    <h4 class="line-head">Datos del Directivo</h4>
    <form id="editFormUsuario" name="editFormUsuario"method="post" enctype="multipart/form-data" rol="form" >
      ...
      <?php
        ...
        $editarDirectivo = new ControladorDirectivo();
        $editarDirectivo->ctrEditarDirectivo();
      ?>
    </form>
  </div>
</div>