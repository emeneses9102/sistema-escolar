...
class ModeloListaDeuda{
    static public function mdlMostrarDeudores($tabla,$item,$valor){
        ...
        {//usamos esta consulta para listar todos los usuarios
            $stmt = Conexion::conectar()->prepare("SELECT ac.idAlumno_cobros,c.detalle,u.usuario_id, u.nombres, u.apellidos,n.nombre_nivel, u.correo, u.telefono_fijo,ap.nombres_apoderado,ap.apellidos_apoderado, ac.estado,g.nombre_grado, s.nombre_seccion FROM $tabla AS ac
           INNER JOIN alumno a
            ON ac.idAlumno = a.idAlumno
            ...
            ON sg.idSeccion = s.idSeccion order by u.nombres asc
            ");
