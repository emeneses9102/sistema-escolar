        ...
        if(isset($_POST['usuario'])){
            ...
            preg_match('/^[a-zA-Z0-9]+$/',$_POST['clave'])){
                ...
                $datos = array("nombre" => $_POST['nombre'],
                                ...
                                "clave" => $encriptar,
                                "listRol" => "3",
                                "titulo_profesor" => $_POST['titulo_profesor'],
                                "listEstado" => $_POST['listEstado'],
                                "correo" => $_POST['correo'],
                                "nacionalidad" => $_POST['nacionalidad'],
                                "fecha_nacimiento" => $_POST['date'],
                                "notas_profesor" => $_POST['notas_profesor'],
                                "foto"=>$ruta);
                
               
                

                $respuesta = ModeloProfesores :: mdlIngresarProfesores($tabla,$datos);
                ...
                if($respuesta == "ok"){
                    ...
                    if($respuesta == "repet"){
                        ...
                        swal.fire({
                            type:"error",
                            title : "El profesor no se registró",
                            showConfirmButton: true,
                            confirmButtonText: "Cerrar",
                            closeOnConfirm: false
                        }).then((result)=>{
         ...
         if(isset($_POST['idusuario'])){
            if(preg_match('/^[a-zA-Z0-9_\sñÑáéíóúÁÉÍÓÚ]+$/',$_POST['editNombre'])){
                ...
                $datos = array("nombre" => $_POST['editNombre'],
                                ...
                                "profesor_titulo" => $_POST['editTitulo_profesor'],
                                "notas_profesor" => $_POST['editNotas_profesor'],
                ...
                $respuesta = ModeloProfesores :: mdlEditarProfesores($tabla,$datos);
                ...
                if($respuesta == "ok"){
                    ...
                    if($_SESSION['usuario'] ==$_POST['editUsuario'] ){
                        ...
                        swal.fire({
                            type:"error",
                            title : "El profesor no se actualizó",
                            showConfirmButton: true,
                            confirmButtonText: "Cerrar",
                            closeOnConfirm: false
                        }).then((result)=>{
